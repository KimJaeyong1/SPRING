	...
	<form action="/galleryModifyAction" method="post" enctype="multipart/form-data">
		<div class="row gx-5 align-items-center justify-content-center">
			<div class="col-3">
				...
				<input type="text" class="form-control" id="gi_no" name="gi_no" value="${galleryInfo.gi_no }" readonly>
			</div>
			<div class="col-4">
				<label class="form-label">작성자</label>
				<input type="text" class="form-control" id="gi_writer" name="gi_writer" value="${galleryInfo.gi_writer }" readonly>
			</div>
			<div class="col-7 mt-3">
				<label class="form-label">제목</label>
				<input type="text" class="form-control" id="gi_title" name="gi_title" value="${galleryInfo.gi_title }">
			</div>
			<div class="col-7 mt-3">
				<label class="form-label">내용</label>
				<textarea class="form-control" id="gi_content" name="gi_content" rows="10" style="resize:none">${galleryInfo.gi_content }</textarea>
			</div>
			<!-- 첨부파일 -->
